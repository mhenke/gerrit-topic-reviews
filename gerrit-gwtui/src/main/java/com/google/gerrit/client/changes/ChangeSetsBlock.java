...
public class ChangeSetsBlock extends Composite {
  ...
  public void display(final TopicDetail detail, final PatchSet.Id diffBaseId) {
    clear();
    ...
    if (Gerrit.isSignedIn()) {
      ...
      // TODO Do we need a different setting for the changesets?
  ...
  private void add(final ChangeSetComplexDisclosurePanel changeSetPanel) {
    ...
    changeSetPanel.addClickHandler(activationHandler);
    changeSetPanels.put(id, changeSetPanel);
  }

  // TODO reassign the registered keys
...
//    } else {
      // TODO
      // .toTopic
      //Gerrit.display(PageLinks.toChange(changeSetId.getParentKey()));
//    }
  }
